const Collection = () => {
  return (
    <>  
        <div className=" h-28  flex justify-center bg-[#F5EFD6] ">
            {/* <div className="h-28 flex justify-center"> */}
                <div className="flex justify-center h-full  bg-white pt-2 rounded-2xl">
                    
                    <div className="capitalize w-100 bg-white text-black flex justify-center items-center gap-2">
                        <img src="/img/medal-1.png" alt="" />
                        <span>Trusted By Thousands</span>
                    </div>
                    <div className="w-100 h-full flex justify-center items-center bg-white text-black">
                        <div className="capitalize w-full h-full flex justify-center items-center bg-[#F5EFD6] rounded-t-2xl gap-2">
                            <img src="/img/protection.svg" alt="" />
                            <span>14+ Years Of Expertise</span>
                        </div>
                    </div>
                    <div className="capitalize w-100 flex justify-center items-center bg-white text-black gap-2">
    ...
    <section className="relative w-full h-dvh flex flex-col justify-center bg-[#F5EFD6]">
        ...
        <div className="w-full flex flex-col items-center gap-y-8 z-0 text-black ">
        ...
        <div className="w-full px-10 flex gap-6 relative mt-10">
            <div className="w-full h-125 bg-white rounded-2xl flex flex-col justify-center items-center text-black px-6 -rotate-6">
                <img src="#" alt="" />
                <div className="flex capitalize gap-2">
                    <p>Essential Body Wave (Mink Hair)</p>
            ...
            <div className="w-full h-125 bg-white rounded-2xl flex flex-col justify-center items-center text-black px-6 -rotate-4">
                <img src="#" alt="" />
                <div className="flex capitalize gap-2">
                    <p>Essential Body Wave (Mink Hair)</p>
                    <span className="font-semibold text-[#5B4E45]">$85.00</span>
            ...
            <div className="w-full h-125 bg-white rounded-2xl flex flex-col justify-center items-center text-black px-6">
                <img src="#" alt="" />
                <div className="flex capitalize gap-2">
                    <p>Essential Body Wave (Mink Hair)</p>
                    <span className="font-semibold text-[#5B4E45]">$85.00</span>
        ...
        <div className="w-full flex justify-center mb-8 mt-18">
