const Header = () => {
  return (
    <>
    <header className="w-full h-40 px-12 bg-amber-100">
        <nav className="w-full h-full flex justify-center items-center pt-8">
            ...
            <div className="flex  justify-center items-center w-full h-full gap-3">
                <button className="w-60 h-14 bg-amber-300 rounded-4xl capitalize ">
                    make an appointment
                </button>
                <div>
                    <svg  xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#fffdfd" viewBox="0 0 24 24" >
