const Header = () => {
  return (
    <>
    <header className="w-full h-40 px-12 z-10">
        <nav className="w-full h-full flex justify-between items-center pt-8  ">
            ...
            <div className="flex  justify-center items-center w-100 h-full gap-3">
                ...
                <div className="w-12 h-12 border-[1px] border-[#e1e1e140] border-solid rounded-full flex justify-center items-center gap-2">
