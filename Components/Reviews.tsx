...
const Reviews = () => {
  return (
    <section className='w-full h-screen relative bg-white z-10'>
        <img src="/img/bg-avh-standard.png" className='absolute top-0 left-0 h-260 bg-cover w-full ' alt="" />
        ...
        <div className='flex gap-3 px-24 bg-white  '>
            ...
            <div className='w-full h-full  flex justify-center z-0'>
                <div className='w-136 h-100 flex flex-col justify-center items-center px-10 bg-linear-to-b from-[#fbfaf8] to-[#f0eee6] absolute top-[80%] rounded-2xl'>
